...
def stockss():
  ...
  immediatebuy = input("Do you want to buy a stock, look at the stocks, sell a stock, or go back to the menue? \n(write \"buy\" or \"look\" or \"sell\" or \"menue\"): ")
  if immediatebuy.lower() == "look":
    ...
    wannabuyorselle = input("Do you want to sell a stock or go to the menue? (write \"sell\" or \"menue\"): ")
    if wannabuyorselle.lower() == "menue":
      menue()
    elif wannabuyorselle.lower() != "sell" and wannabuyorselle.lower() != "menue":
